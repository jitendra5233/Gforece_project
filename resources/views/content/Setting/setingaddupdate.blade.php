      ...
      <div class="card-body">
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
             ...
             {{-- <div class="mb-3 col-md-6">
              <label for="facebook" class="form-label">Facebook Links</label>
              <input class="form-control" type="text" name="facebook" id="facebook" value="{{$row->facebook}}" />
            </div>
            <div class="mb-3 col-md-6">
              <label for="Twitter" class="form-label">Twitter Links</label>
              <input class="form-control" type="text" name="Twitter" id="Twitter" value="{{$row->Twitter}}" />
            </div>
             <div class="mb-3 col-md-6">
              <label for="YouTube" class="form-label">YouTube Links</label>
              <input class="form-control" type="text" name="YouTube" id="YouTube" value="{{$row->YouTube}}" />
            </div>
            <div class="mb-3 col-md-6">
              <label for="Instagram" class="form-label">Instagram Links</label>
              <input class="form-control" type="text" name="Instagram" id="Instagram" value="{{$row->Instagram}}" />
            </div> --}}
            <div class="mb-3 col-md-12">
...
<option value='fab fa-youtube-square'>&#xf166; youtube-square</option>
            ...
            <div class="mb-3 col-md-12">
              <h5 class="card-header p-0 my-3">Price Filter</h5>
            </div>

            <div class="mb-3 col-md-12">
              <h6 class="card-header p-0 mb-2">Buy Price Filter</h6>
            </div>

            <div class="mb-3 col-md-4">
              <label for="min_price_buy" class="form-label">Min Price Buy</label>
              {{-- <input class="form-control" type="number" name="min_price_buy" id="min_price_buy" value="{{$row->min_price_buy}}" /> --}}
              <div class="input-group">
                <input type="number" class="form-control" name="min_price_buy" id="min_price_buy" value="{{$row->min_price_buy}}">
                <span class="input-group-text" id="basic-addon13">K</span>
              </div>
            </div>

            <div class="mb-3 col-md-4">
              <label for="diff_val_buy" class="form-label">Difference Value Buy</label>
                {{-- <input class="form-control" type="number" name="diff_val_buy" id="diff_val_buy" value="{{$row->diff_val_buy}}" /> --}}
                <div class="input-group">
                  <input class="form-control" type="number" name="diff_val_buy" id="diff_val_buy" value="{{$row->diff_val_buy}}">
                  <span class="input-group-text" id="basic-addon13">K</span>
                </div>
             ...
             <div class="mb-3 col-md-4">
              <label for="max_price_buy" class="form-label">Max Price Buy</label>
             {{-- <input class="form-control" type="number" name="max_price_buy" id="max_price_buy" value="{{$row->max_price_buy}}" /> --}}
              <div class="input-group">
                <input class="form-control" type="number" name="max_price_buy" id="max_price_buy" value="{{$row->max_price_buy}}">
                <span class="input-group-text" id="basic-addon13">K</span>
              </div>
             ...
             <div class="mb-3 col-md-12">
              <h6 class="card-header p-0 mb-2">Rent Price Filter</h6>
            </div>

            <div class="mb-3 col-md-4">
               <label for="min_price_rent" class="form-label">Min Price Rent</label>
               {{-- <input class="form-control" type="number" name="min_price_rent" id="min_price_rent" value="{{$row->min_price_rent}}" /> --}}
               <div class="input-group">
                <input class="form-control" type="number" name="min_price_rent" id="min_price_rent" value="{{$row->min_price_rent}}">
                <span class="input-group-text" id="basic-addon13">K</span>
              </div>
            ...
            <div class="mb-3 col-md-4">
               <label for="diff_val_rent" class="form-label">Difference Value Rent</label>
                {{-- <input class="form-control" type="number" name="diff_val_rent" id="diff_val_rent" value="{{$row->diff_val_rent}}" /> --}}
                <div class="input-group">
                  <input class="form-control" type="number" name="diff_val_rent" id="diff_val_rent" value="{{$row->diff_val_rent}}">
                  <span class="input-group-text" id="basic-addon13">K</span>
                </div>
             ...
             <div class="mb-3 col-md-4">
             <label for="max_price_rent" class="form-label">Max Price Rent</label>
             {{-- <input class="form-control" type="number" name="max_price_rent" id="max_price_rent" value="{{$row->max_price_rent}}" /> --}}
              <div class="input-group">
                <input class="form-control" type="number" name="max_price_rent" id="max_price_rent" value="{{$row->max_price_rent}}">
                <span class="input-group-text" id="basic-addon13">K</span>
              </div>
           ...
           <div class="mb-3 col-md-12">
            ...
            <div class="mb-3 col-md-6">
             <label for="creersEmail" class="form-label">Email for Creers Page</label>
...
deleteItemAm = (id) =>{
  ...
  settingformsubmit = () =>
  {
        ...
        var min_price_buy =document.getElementById('min_price_buy').value;
        var diff_val_buy =document.getElementById('diff_val_buy').value;
        var max_price_buy =document.getElementById('max_price_buy').value;
        
        var min_price_rent =document.getElementById('min_price_rent').value;
        var diff_val_rent =document.getElementById('diff_val_rent').value;
        var max_price_rent =document.getElementById('max_price_rent').value;
  ...
  //   $('#facebook').after('<span class="error">This field is required*</span>');
  //   return false;
  //   }
  //   if (Twitter.length < 1) {
  //   $('#Twitter').after('<span class="error">This field is required*</span>');
  //   return false;
  //   }
  //   if (YouTube.length < 1) {
  //   $('#YouTube').after('<span class="error">This field is required*</span>');
  //   return false;
  //   }
  //    if (Instagram.length < 1) {
  //   $('#Instagram').after('<span class="error">This field is required*</span>');
  //   return false;
  //   }
  ...
  if (ameneties.length < 1) {
    ...
    if (min_price_buy.length < 1) {
      $('#min_price_buy').after('<span class="error">Min Price for Buy is Required *</span>');
      return false;
    }
    if (diff_val_buy.length < 1) {
      $('#diff_val_buy').after('<span class="error">Difference Value for Buy is Required*</span>');
      return false;
    }
    if (max_price_buy.length < 1) {
      $('#max_price_buy').after('<span class="error">Max Price for Buy is Required *</span>');
      return false;
    }
    
     if (min_price_rent.length < 1) {
      $('#min_price_rent').after('<span class="error">Min Price For Rent  is Required *</span>');
      return false;
    }
    if (diff_val_rent.length < 1) {
      $('#diff_val_rent').after('<span class="error">Difference Value For Rent is Required*</span>');
      return false;
    }
    if (max_price_rent.length < 1) {
      $('#max_price_rent').after('<span class="error">Max Price For Rent is Required *</span>');
      return false;
    }
