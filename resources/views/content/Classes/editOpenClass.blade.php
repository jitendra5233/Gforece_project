          ...
          <div class="card-body">
              ...
              <div class="mb-3 col-md-6">
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <select id="branchname" name="branchname" class="form-select"  aria-label="Default select example">
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="Date" id="scheduledate" name="scheduledate" value="{{$openClass->scheduledate}}" />
                  </div>
